	...
	export default {
		...
		data() {
			return {
				...
				filtrateList: [
					{
						'shopTypeId': '08f13873bd1481b984f3bb8e41f4e8a7',
						'shopTypeName': '全部',
						'imgUrl':'/static/sszy_all.png',
						'isChecked': true
					}
				],
				recommendObj: {}
...
<style lang="scss" scoped>
	...
	.vegetarian-diet {
		width: 750rpx;
		// height: 1600rpx;
		border-top: 0.2rpx solid #1DBF93;
		.title {
			.actived {
			...
			color: #FFFFFF;
			font-weight: 500;
			background: linear-gradient(to right, #4AD5AF , #1DBF93);
			// display: flex;
			// align-items: center;
			// justify-content: center;
			position: relative;
